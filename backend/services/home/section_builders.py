    ...
    def build_service_prompts(
        ...
        if not download_client_configured:
            prompts.append(ServicePrompt(
                ...
                description="SongSeek needs a download source (slskd for Soulseek, or SABnzbd + an indexer for Usenet) to fetch the albums and tracks you request. Add one in Settings to start downloading into your library.",
                icon="🎶",
                color="accent",
