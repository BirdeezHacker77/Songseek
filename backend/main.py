...
from api.v1.routes import import_review as import_review_routes
from api.v1.routes import enrichment_history as enrichment_history_routes
...
v1_router.include_router(import_review_routes.router)
v1_router.include_router(enrichment_history_routes.router)
