		...
		<div class="card bg-base-200">
			<div class="card-body gap-4">
				...
				<div class="alert alert-warning alert-soft text-sm">
					<CircleAlert class="h-4 w-4 shrink-0" />
					<span>
						<strong>Only enable if you are serving SongSeek over HTTPS.</strong> Enabling HSTS on a plain
						HTTP install will lock users out until the HSTS header expires in their browser.
					</span>
				</div>
